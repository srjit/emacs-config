...
(fringe-mode '(0 . 0))
(defface fallback '((t :family "Inconsolata-14"
...
(set-fontset-font "fontset-default"  '(#x2600 . #x26ff) "Inconsolata-14")
...
(defun elegance-light ()
    ...
    (set-background-color "#eadbc8")
    (set-foreground-color "#333333")
    (set-face-attribute 'default nil
                        :foreground (face-foreground 'default)
                        :background (face-background 'default))
    (set-face-attribute 'face-critical nil :foreground "#919191"
                                           :background "#ff6347")
    (set-face-attribute 'face-popout nil :foreground "#575757")
    (set-face-attribute 'face-strong nil :foreground "#333333"
                                         :weight 'regular)
    (set-face-attribute 'face-salient nil :foreground "#00008b"
                                          :weight 'light)
    (set-face-attribute 'face-faded nil :foreground "#6b6b6b"
                                        :weight 'light)
    (set-face-attribute 'face-subtle nil :background "#969696")
